...
//	}
	...
	public TransitionRelation(CfgProcedure cfg, AbstractControlFlowFactory cff, Prover p) {
		super(cfg, cff, p);
		 //*********************Handle Global axioms
		makePrelude();

		//*********************Tell prover it is a boolean type
...
//	}
	 ...
	 */
	@Override
	public List<ProverExpr> statements2proverExpression(List<CfgStatement> stmts) {
	 ...
	 */
	@Override
	public ProverExpr statement2proverExpression(CfgStatement s) {
		if (s instanceof CfgAssertStatement) {
