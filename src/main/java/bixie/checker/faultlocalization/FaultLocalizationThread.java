...
public class FaultLocalizationThread implements Runnable {
	 ...
	 */
	@Loggable
	private List<Map<CfgStatement, SourceLocation>> localizeFaults(AbstractTransitionRelation tr, Set<BasicBlock> infeasibleBlocks) {
	...
	public SourceLocation praseLocationTags(Attribute[] attributes) {
		if (attributes == null)
			return null;
